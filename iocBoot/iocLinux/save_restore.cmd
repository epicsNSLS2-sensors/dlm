...
save_restoreSet_status_prefix("dlm:")
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=dlm:, DEAD_SECONDS=5")
...
set_pass0_restoreFile("auto_positions.sav", "P=dlm:")
# Save positions every five seconds
doAfterIocInit("create_monitor_set('auto_positions.req',5,'P=dlm:')")

set_pass0_restoreFile("auto_settings.sav", "P=dlm:")
set_pass1_restoreFile("auto_settings.sav", "P=dlm:")
# save settings every thirty seconds
doAfterIocInit("create_monitor_set('auto_settings.req',30,'P=dlm:')")

# Note that you can reload these sets after creating them: e.g., 
# reload_monitor_set("auto_settings.req",30,"P=dlm:")
...
#set_pass0_restoreFile("myGenericData.sav", "P=dlm:")
#set_pass1_restoreFile("myGenericData.sav", "P=dlm:")
...
set_requestfile_path("$(TOP)", "dlmApp/Db")
